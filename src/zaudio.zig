...
pub const seekProc = *const fn (user_data: ?*anyopaque, offset: i64, origin: SeekOrigin) callconv(.c) Result;
...
pub const decoderSeekProc = fn (decoder: *Decoder, byte_offset: i64, origin: SeekOrigin) callconv(.c) Result;
